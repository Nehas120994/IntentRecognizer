...
/*
  ...
  Adding to this knowledge base can extend the capability
...
public:
    ...
    /*
        ...
        To understand the stop words better further refer this 
        https://kavita-ganesan.com/what-are-stop-words/#.Yo9LdKjP02w
    */
    const std::vector<std::string> STOPWORDS{
        ...
        "should", "now"};
    /*
      Below is a collection of words denoting time which can be used for
      extending the intent recognition to include intent related to time.
    */
    /*
